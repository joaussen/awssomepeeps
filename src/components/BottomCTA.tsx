...
export function BottomCTA({ onOpenForm }: BottomCTAProps) {
  return (
    <div className="mt-20 bg-gray-900 rounded-t-2xl">
      <div className="max-w-2xl mx-auto px-6 py-16 text-center">
        ...
        <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-6 text-left max-w-md mx-auto mb-8">
          ...
          <button
            onClick={onOpenForm}
            className="w-full inline-flex items-center justify-center gap-2 bg-brand hover:bg-brand-dark text-gray-900 font-semibold px-6 py-3 rounded-lg text-sm transition-colors cursor-pointer"
          >
        ...
        <p className="text-gray-600 text-xs leading-relaxed max-w-lg mx-auto">
          <span className="font-medium text-gray-500">Disclaimer:</span> Awssome facilitates introductions between talent and ISV partners. We are not a recruitment agency. All employment decisions are made independently by partner companies.
        </p>
      </div>
